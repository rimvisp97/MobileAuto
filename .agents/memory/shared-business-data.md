...
**How to apply:** Load vehicles, donors, expenses, sales, and parts from the API with focus/poll refresh. Legacy imports must be additive, preserve empty arrays and stored rows, and never write server snapshots back over local backups.
