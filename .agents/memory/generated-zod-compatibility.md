...
After OpenAPI generation, replace Zod 4-only primitive helpers with their Zod 3 equivalents and preserve the selective generated-type exports.
...
**How to apply:** After every API codegen run, check generated validation output for unsupported helpers and check the validation package barrel for duplicate wildcard exports before running library typechecks.